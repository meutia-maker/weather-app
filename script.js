...
const apiKey = 'd796b857874f65f611c03bb9f29e9f81'
...
function getWeatherIcon(id) {
    ...
    if (id <= 751) return 'atmosphere.svg'
...
async function updateForcastInfo(city) {
    ...
    forcastData.list.forEach(forcastWeather => {
        if (forcastWeather.dt_txt.includes(timeTaken)&&
            ...
            updadateForecastItems(forcastWeather)
        } 
    })
    
}

function updadateForecastItems(weatherData) {
